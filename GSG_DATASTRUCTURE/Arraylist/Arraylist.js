...
list1.addLast(5);
list1.addLast(6);
list1.traverse(); // Output: 3 2 1 4 5 6
console.log("************");

list1.delFirst();
list1.traverse(); // Output: 2 1 4 5 6
console.log("************");

list1.delLast();
list1.traverse(); // Output: 2 1 4 5
console.log("************");

list1.addAtPos(2, 9);
list1.traverse(); // Output: 2 1 9 4 5
console.log("************");

list1.DelAtPos(3);
list1.traverse(); // Output: 2 1 9 5
